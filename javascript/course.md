...
- Este es un curso dividido en modulos, temas y subtopicos.
...
- Cada subtopico tiene un id único consecutivo y un nombre descriptivo.
- Cada módulo contiene temas y cada tema tiene subtopicos.
- Cada subtopico debe ser explicado en profundidad, cubriendo todos los aspectos relevantes.
- Cada subtopico debe incluir ejemplos prácticos, mejores prácticas, advertencias y código de ejemplo.
- Cada subtopico debe incluir preguntas de examen profundas y explicaciones detalladas.
- Cada subtopico debe incluir prácticas sugeridas y código de ejemplo.
- Cada subtopico debe incluir novedades de ES6+ y diferencias entre navegador y Node.js.
- Cada subtopico debe incluir términos clave traducidos entre español e inglés.
- Cada subtopico debe incluir un análisis de funcionamiento interno, optimización y mejores prácticas.
- Cada subtopico debe incluir advertencias sobre errores comunes y malas prácticas.
- Cada subtopico debe incluir un análisis de las diferencias entre JavaScript y TypeScript. - Sigue estrictamente la estructura del yml o txt proporcionado.
- Si encuentras un subtopico que ya ha sido completado, ignóralo y continúa con el siguiente.
- Si identificas un subtopico que no existe, sugiere en qué modulo, tema o subtopico debería incluirse.
- Para cada subtopico, revisa los anteriores para asegurar comprensión.
...
- Para cada tópico, genera 3 preguntas de examen profundas (no fáciles):
...
- Da siempre la respuesta correcta y una explicación completa.
- Menciona prácticas sugeridas y código de ejemplo por subtopico.
...
### 2.5 - Módulos, Espacios de Nombres y Declaraciones Avanzadas (INCOMPLETO)

- 2.5.1 - Módulos, Namespaces y Declaraciones (.d.ts, declare global, module augmentation) (INCOMPLETO)

- 2.5.2 - Importación y exportación de tipos vs. valores (INCOMPLETO)

- 2.5.3 - Type-Only Imports/Exports y el flag isolatedModules (INCOMPLETO)

### 2.6 - Decoradores, Metaprogramación y Configuración Avanzada (INCOMPLETO)

- 2.6.1 - Decoradores de clase, propiedad, parámetro y acceso (INCOMPLETO)

- 2.6.2 - Decoradores, Reflect-metadata y Limitaciones (INCOMPLETO)

- 2.6.3 - Configuración avanzada de tsconfig.json, Monorepos y Herramientas (INCOMPLETO)

- 2.6.4 - Decorators Stage 3 y Metadata Reflection (INCOMPLETO)

### 2.7 - Diseño y Validación de APIs con TypeScript (INCOMPLETO)

- 2.7.1 - Tipificación de Entidades, DTOs y Validación de Esquemas (INCOMPLETO)

- 2.7.2 - Validación de tipos en tiempo de ejecución vs. compilación (INCOMPLETO)

- 2.7.3 - Generación de Tipos y Documentación Automática (INCOMPLETO)

### 2.8 - Inferencia de Tipos y Strictness en TypeScript (INCOMPLETO)

- 2.8.1 - Inferencia de Tipos y Migración Progresiva (INCOMPLETO)

- 2.8.2 - Limitaciones de la inferencia y cómo solucionarlas (INCOMPLETO)

- 2.8.3 - Strictness Flags y Control de Errores (INCOMPLETO)
...
### 4.2 - Bases de Datos Avanzadas con Node.js (INCOMPLETO)
...
### 6.4 - Routing y Navegación en React (INCOMPLETO)
...
- 6.11.1 - Patrones de composición y render props (INCOMPLETO)
...
- 6.19.1 - React Profiler, bundle analysis, lazy loading de imágenes, optimización de assets (INCOMPLETO)
